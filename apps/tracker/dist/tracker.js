...
function de(e, t) {
	let n = te(e);
	t ||= 0;
	let r = [0, n.length], i = r[1] % 16, a = r[1] - i, o = [0, t], s = [0, t], c = [0, 0], l = [0, 0], u = 0;
	for (; u < a; u += 16) c[0] = n[u + 4] | n[u + 5] << 8 | n[u + 6] << 16 | n[u + 7] << 24, c[1] = n[u] | n[u + 1] << 8 | n[u + 2] << 16 | n[u + 3] << 24, l[0] = n[u + 12] | n[u + 13] << 8 | n[u + 14] << 16 | n[u + 15] << 24, l[1] = n[u + 8] | n[u + 9] << 8 | n[u + 10] << 16 | n[u + 11] << 24, g(c, oe), ne(c, 31), g(c, se), v(o, c), ne(o, 27), h(o, s), g(o, ce), h(o, le), g(l, se), ne(l, 33), g(l, oe), v(s, l), ne(s, 31), h(s, o), g(s, ce), h(s, ue);
			...
			try {
				...
				switch (i(t) && s(t), e.state) {
					case "running":
						c = Date.now(), a && l();
						break;
					case "suspended": document.hidden || o++, a && o >= 3 ? r(Be("suspended")) : setTimeout(u, 500);
				}
			} catch (e) {
				r(e);
			}
...
var hn = -1, gn = -2, _n = /* @__PURE__ */ new Set([
	10752,
	2849,
	2884,
	2885,
...
Q.prototype.get = function(e) {
	...
	switch (this.itemType != A && ii.call(this.data, this.ua, this.rgxMap), this.itemType) {
		case T:
			...
			break;
		case k: if (this.get(j) == "iOS" && this.get(P) && /^1[89][^\d]/.exec(this.get(P))) {
...
function $(e, t, n) {
	if (typeof e === w.OBJECT ? (Zr(e, !0) ? (typeof t === w.OBJECT && (n = t), t = e) : (n = e, t = void 0), e = void 0) : typeof e === w.STRING && !Zr(t, !0) && (n = t, t = void 0), n) {
		if (typeof n.append === w.FUNCTION) {
			var r = {};
...
var pi = async (e, t) => {
	...
	document.addEventListener("click", (t) => {
		let i = t.target, a = () => {
			let n = i.getBoundingClientRect(), a = {
				visitorId: e,
				event: t.type,
				payload: {
...
function ki(e, t) {
	let n = Oi.get(t);
	return n || (n = /* @__PURE__ */ new WeakMap(), Oi.set(t, n)), n.get(e) || n.set(e, new t()), n.get(e);
}
var Ai = class {
	t;
	i = 0;
...
}, Ni = -1, Pi = /* @__PURE__ */ new Set(), Fi = () => document.visibilityState !== "hidden" || document.prerendering ? 1 / 0 : 0, Ii = (e) => {
